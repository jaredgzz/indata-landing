...
import './LangflowLeadForm.css'

const INITIAL_FORM = { nombre: '', email: '', empresa: '', phone: '' }

function triggerDownload() {
  const a = document.createElement('a')
  a.href = '/docs/curso-agentes-langflow.pdf'
  a.download = 'Programa-Agentes-LangFlow-InDatA.pdf'
  a.click()
}

export default function LangflowLeadForm({ isOpen, onClose }) {
